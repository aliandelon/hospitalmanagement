...
?>
            <div class="content">
                ...
                <?php foreach ($doctorsList as $key => $value) { 
                    $id = $value['id'];
                    $path = Yii::$app->request->baseUrl .'/uploads/doctors/'.$id.'.'.$value['img'];
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0"><?php echo isset($value['name']) ? $value['name'] : "";?></h3>
                                                <small class="text-muted"><?php echo isset($value['spectial']) ? $value['spectial'] : "";?></small>
                                                <div class="staff-id">Employee ID : <?php echo isset($value['registration_no']) ? $value['registration_no'] : "";?></div>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <span class="text"><a href="#"><?php echo isset($value['phone']) ? $value['phone'] : "";?></a></span>
                                                </li>
                                                <li>
                                                    <span class="title">Email:</span>
                                                    <span class="text"><a href="#"><?php echo isset($value['email']) ? $value['email'] : "";?></a></span>
                                                </li>
                                                <li>
                                                    <span class="title">Address:</span>
                                                    <span class="text"><?php echo isset($value['address']) ? $value['address'] : "&nbsp;";?></span>
                                                </li>
                                                <li>
                                                    <span class="title">Gender:</span>
                                                    <span class="text"><?php echo ($value['gender'] != 'M') ? "Male" : "Female";?></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
